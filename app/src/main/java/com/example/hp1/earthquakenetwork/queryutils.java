...
*/
    ...
    public static ArrayList fetchEarthquakeData(String requestUrl) {
        ...
        ArrayList earthquake = extractEarthquakesJson(jsonResponse);
     ...
     */
    public static ArrayList<info> extractEarthquakesJson(String url) {
...
//Log.e(LOG_TAG,"hello");
            ...
            for(int i=0;i<feature.length();i++){
                JSONObject respose=feature.getJSONObject(i) ;
                JSONObject property=respose.getJSONObject("properties");
                String mag=property.getString("mag");
                String loc=property.getString("place");
                String time=property.getString("time");
                earthquakes.add(new info(mag, loc, time));
            }
